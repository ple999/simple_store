...
migrateup:
	migrate -path ./migration_file -database "postgresql://alpine12:password12@0.0.0.0:5000/simple_store?sslmode=disable" -verbose up
migratedown:
	migrate -path ./migration_file -database "postgresql://alpine12:password12@0.0.0.0:5000/simple_store?sslmode=disable" -verbose down
