...
migrateup:
	migrate -path ./migration_file -database "postgresql://alpine12:password12@172.18.0.1:5432/simple_store?sslmode=disable" -verbose up
migratedown:
	migrate -path ./migration_file -database "postgresql://alpine12:password12@172.18.0.1:5432/simple_store?sslmode=disable" -verbose down
