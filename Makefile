...
migrateup:
	migrate -path ./migration_file -database "postgresql://alpine12:Password12@simplestore.c1mcymgymn7x.eu-west-2.rds.amazonaws.com:5432/simplestore" -verbose up
migratedown:
	migrate -path ./migration_file -database "postgresql://alpine12:Password12@simplestore.c1mcymgymn7x.eu-west-2.rds.amazonaws.com:5432/simplestore" -verbose down
